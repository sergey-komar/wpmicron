    ...
    <img src="./images/home/микрометры.jpeg" alt="img" class="category-block__item-img">
    <div class="category-block__item-title">Микрометры</div>
    </a>
    <a href="#" class="category-block__item">
    <img src="./images/home/микрометры.jpeg" alt="img" class="category-block__item-img">
    <div class="category-block__item-title">Калибры для метрической резьбы М</div>
    </a>
    <a href="#" class="category-block__item">
    <img src="./images/home/микрометры.jpeg" alt="img" class="category-block__item-img">
    <div class="category-block__item-title">Микрометры</div>
    ...
    <div class="container">
        ...
        <div class="advantages-block__item">
            <img src="./images/icon/advantages-1.svg" alt="img" class="advantages-block__item-img">
        ...
        <div class="advantages-block__item">
            <img src="./images/icon/advantages-2.svg" alt="img" class="advantages-block__item-img">
        ...
        <div class="advantages-block__item">
            <img src="./images/icon/advantages-3.svg" alt="img" class="advantages-block__item-img">
        ...
        <div class="advantages-block__item">
            <img src="./images/icon/advantages-4.svg" alt="img" class="advantages-block__item-img">
    ...
    <div class="container">
        ...
        <div class="production-block__desc">
            ...
            <img src="./images/home/about-2.png" alt="img" class="production-block__desc-img">
            <div class="production-block__desc-title">
            <span>3</span>Производства
            </div>
            <img src="./images/home/about-1.png" alt="img" class="production-block__desc-img">
            <div class="production-block__desc-title">
            <span>35</span>
            Товарных категорий
            </div>
